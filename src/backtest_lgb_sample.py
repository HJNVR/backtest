...
class BackTest:
    def __init__(self):
        self.backtest_config = BacktestConfig(lgb_sample=True)
        self.backtest_dataset = BacktestDataset(lgb_sample=True)
    ...
    def plot(self):
        ...
        fig.suptitle('Sample Paper 9. Forecasting daily stock market return using dimensionality reduction | LightGBM | (201701, 201705)', \
